...
const renderUser = doc => {
  ...
  btnEdit.addEventListener('click', () => {
    ...
    editModalForm.post.value = doc.data().post;
    editModalForm.Description.value = doc.data().Description;
    editModalForm.comment.value = doc.data().comment;
...
btnAdd.addEventListener('click', () => {
  ...
  addModalForm.post.value = '';
  addModalForm.Description.value = '';
  addModalForm.comment.value = '';
});
...
addModalForm.addEventListener('submit', e => {
  ...
  db.collection('users').add({
    ...
    post: addModalForm.post.value,
    Description: addModalForm.Description.value,
    comment: addModalForm.comment.value,
  });
...
editModalForm.addEventListener('submit', e => {
  ...
  db.collection('users').doc(id).update({
    ...
    post: editModalForm.post.value,
    Description: editModalForm.Description.value,
    comment: editModalForm.comment.value,
  });
  editModal.classList.remove('modal-show');
